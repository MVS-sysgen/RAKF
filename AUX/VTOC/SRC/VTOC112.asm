...
SORTTABX DC    AL2(VTFDSN-VTFMT),AL2(43),CL8'DSNAME'
         ...
         DC    AL2(VTFRACF-VTFMT),AL2(2),CL8'RACF'
         DC    F'0'
         EJECT
*
*        PROGRAM MESSAGES
...
SORTKTAB DC    AL2(VTFDSN-VTFMT),AL2(DSNSORTE-DSNSORT)
         ...
         DC    AL2(VTFRACF-VTFMT),AL2(RCFSORTE-RCFSORT)
         DC    A(RCFSORT),A(RCFSORTE)
         DC    2F'0'
         SPACE 3
...
RCFSORT  DC    A(0),AL2(0),CL6'Y'
RCFSORTE DC    A(0),AL2(0),CL6'N'
         EJECT
*
*
